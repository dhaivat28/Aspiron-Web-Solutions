...
$mail->Subject = 'New Coffee Request generated';
$mail->Body    = $message;
...
if(!$mail->send()) {
   echo 'Message could not be sent.<META HTTP-EQUIV="REFRESH" CONTENT="2; URL=http://www.aspironweb.com/contacts.html">';
   echo 'Mailer Error: ' . $mail->ErrorInfo;
   exit;
}
 
echo 'Message has been sent.<META HTTP-EQUIV="REFRESH" CONTENT="2; URL=http://www.aspironweb.com/contacts.html">';
?>